<?php
/**
 * Adds spatial radius search functionality.
 *
 ...
 *
 * @param float $latitude_from The latitude of the first point.
 * @param float $longitude_from The longitude of the first point.
 * @param float $latitude_to The latitude of the second point.
 * @param float $longitude_to The longitude of the second point.
 */
 ...
 *
 * @param array $conversations The list of conversations to filter.
 * @param float $radius_distance The list of
 */
