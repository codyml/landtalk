...
<div class="full-bleed-container">
	<div class="columns is-gapless">
		<div class="column is-half">
			<div class=" conversation-image" style="background-image: url('<?php echo esc_url( $historical_image ); ?>');"></div>
		</div>
		<div class="column is-half">
			<div class=" conversation-image" style="background-image: url('<?php echo esc_url( $current_image ); ?>');"></div>
		</div>
	</div>
</div>
...
<div class="container">
	<div class="columns level">
		...
		<a href="../#<?php the_ID(); ?>" class="column is-5 level-item react-component mini-conversation-map" data-component-name="MiniConversationMap" data-component-props="<?php echo esc_attr( landtalk_encode_json_for_html_attr( array( 'postId' => get_the_ID() ) ) ); ?>"></a>
	</div>
</div>
...
<div class="container collapsible-section">
	...
	<div class="columns">
		...
		<div class="column is-one-third">
			...
			<div class="conversation-meta"><strong>Keywords: </strong><?php echo esc_html( implode( ', ', landtalk_get_keywords( $post ) ) ); ?></div>
		</div>
	</div>
</div>
