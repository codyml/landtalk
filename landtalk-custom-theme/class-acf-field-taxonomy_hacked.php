...
/*
*   Modified version of advanced-custom-fields-pro/includes/fields/class-acf-field-taxonomy.php
*   that allows non-logged-in users to add taxonomy terms.
*/
...
class acf_field_taxonomy extends acf_field {
    ...
    */
    ...
    function initialize() {
        ...
        //  CML Added
        add_action('wp_ajax_nopriv_acf/fields/taxonomy/add_term',   array($this, 'ajax_add_term'));
